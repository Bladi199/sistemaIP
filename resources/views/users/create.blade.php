        ...
        <div class="px-8 pt-5 pb-8 overflow-y-auto">
            ...
            <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div x-data="{ show:false }" class="bg-slate-100 p-2 rounded-xl border border-slate-200 relative">
                            ...
                            <button type="button" @click="show = !show"
                                class="absolute right-3 top-1/2 -translate-y-1/16 text-slate-400 hover:text-[#00A59A]">
                                ...
                                <svg x-show="show" class="w-5 h-5" fill="none" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.183-3.883"/>
                                </svg>
                            </button>
                        </div>

                        <div>
                            <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Rol</label>
                            <select name="role_id"
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-2xl border border-gray-100 md:mt-1.5">
                            ...
                            <input type="checkbox" name="status" value="activo" class="w-5 h-5 accent-[#00A59A]" checked>
                        </div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-50">
                    <a href="{{ route('users.index') }}" class="px-6 py-3 border border-gray-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-gray-50 transition-all">
                        Cancelar
                    </a>
